...
<div class="container" style="text-align:center;">
  <div class="row" style="margin-top:20px" >
	...
	<form name="form1" method="post" action="create_event_rso.php" style="text-align:center;">
	<fieldset>
	<h2><?php echo $response ?></h2>
		...
		<?php			
			...
			$query = "SELECT * FROM members WHERE username='$student_name'";
			$result = mysql_query($query);
		?>
		
		<select name="event_rso" id="event_rso" class="form-control">
		<option value="" disabled selected> RSO</option>
		...
		<option value="<?php echo $line['rso_name'];?>"> <?php echo $line['rso_name'];?> </option>
